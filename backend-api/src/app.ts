...
import { v1MasarRoutes } from './routes/v1/masar.js';
...
import { adminMasarBenchmarkRoutes } from './routes/admin/masar-benchmark.js';
...
export async function buildApp(env: Env, ctx: AppCtx) {
  ...
  await app.register(v1MasarRoutes, { prefix: '/v1' });
  ...
  await app.register(adminMasarBenchmarkRoutes, { prefix: '/admin/v1' });
